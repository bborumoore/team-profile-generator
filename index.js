    ...
    inquirer.prompt([
      ...
      },
      {
        ...
        validate: answer => {
          ...
          return "Please enter a phone number, digits only.";
        }
      }
    ]).then(answers => {
        ...
        validate: answer => {
          ...
          if (pass) {
            if (idArray.includes(answer)) {
              return "This ID is already taken. Please try again.";
            } else {
              return true;
            }

          }
          return "Please enter a valid ID (Must be a number greater than 0).";
        }
      },
      {
        type: "input",
